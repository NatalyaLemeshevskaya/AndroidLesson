...
public class Main {
    public static void main(String[] args) {
        ...
        Room room1 = new Room("Комната1",50.0,2);
        Room room2 = new Room("Комната2",14.0,1);
        build.addRoom(room1);
        build.addRoom(room2);

        try {
            room1.addFurniture(new Table(5,"Стол из дуба"));
            room1.addFurniture(new Sofa(10,"Раскладная софа"));
            room1.setUnfreeSq(15);
