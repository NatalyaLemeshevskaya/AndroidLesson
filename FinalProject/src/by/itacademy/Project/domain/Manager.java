...
public class Manager {
    ...
    public void startProject() throws IOException {
        ...
        System.out.println("Введите 1, если хотите вывести все товары и информацию о них \n" +
                "2 - если хотите найти определенный товар\n" +
                "3 - если хотите отсортировать товары ");
